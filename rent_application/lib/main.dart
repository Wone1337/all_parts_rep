...
import 'package:part_12/models/ProfileModel.dart';
import 'package:part_12/repository/firebase_auth.dart';
import 'package:part_12/repository/firestore_service.dart';
import 'package:part_12/screens/AuthScreen.dart';
import 'package:part_12/screens/TabNvigator.dart';
import 'package:part_12/theme/model_theme.dart';
  ...
  _initCurrentUser() async {
    ...
    if (isLoadUser) {
      FirestoreService.getUserById(auth.currentUser!.uid).then((value) {
        if (value != null) {
          setState(() {
            currentUser = ProfileModel.fromJson(value as Map<String, dynamic>) ;
          });
        }
      });
    }
